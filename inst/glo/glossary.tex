...
\newacronym[sort=AUC50]{AUCC50}{\ensuremath{AUC50}}{area under the concentration-time curve at 50\% of the maximum effect}
...
\newacronym{BTR}{BTR}{best tumor response}
...
\newacronym{CWRESI}{CWRESI}{conditional weighted residual with interaction}
...
\newacronym{EWRES}{EWRES}{expected weighted residual}
...
%%%%%%%%% P
\newacronym[shortplural = {PD}, longplural = {pharmacodynamics}]{PD}{PD}{pharmacodynamic}
...
\newacronym{TMDD}{TMDD}{target-mediated drug disposition}
...
\newacronym{WT}{WT}{subject weight}
