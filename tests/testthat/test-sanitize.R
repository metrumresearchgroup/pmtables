...
test_that("brackets are sanitized via sub_bracket", {
  ...
  ans <- tab_prime(data)
  expect_equal(ans[1,1], "\\lbrack2,3\\rbrack")
  expect_equal(ans[1,2], "(9,10\\rbrack")
  expect_equal(ans[1,3], "\\lbrack\\lbrack22,33)")

  ans <- tab_prime(data, sub_bracket = "left")
  expect_equal(ans[1,1], "\\lbrack2,3]")
  ...
  ans <- tab_prime(data)
  expect_equal(ans[1,1], "\\lbrack1,2\\rbrack")
  expect_equal(ans[2,1], "(22,55\\rbrack")
  expect_equal(ans[3,1], "2 to 4")
  expect_equal(ans[4,1], "\\lbrack\\lbrack22,33))")
