...
test_that("cont table all missing", {
  ...
  c <- pt_cont_wide(data, cols = "WT,SCR,ALB", na_action = "pass")
  d <- pt_cont_long(data, cols = "WT,SCR,ALB", na_action = "pass")
  ...
  e <- pt_cont_wide(data, cols = "WT,SCR,ALB", na_action = "pass", na_fill = "NA")
  expect_equal(e$data$SCR, "NA")
  f <- pt_cont_long(data, cols = "WT,SCR,ALB", na_action = "pass", na_fill = "NA")
